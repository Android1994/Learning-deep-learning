...
def create_inception_resnet_v2(nb_classes=1001, scale=True):   ##1001
    '''
    ...
    aux_out = Dense(nb_classes, activation='sigmoid')(aux_out)  ###---softmax--singleLabel; sigmoid--multiLabel
    ...
    # Output
    out = Dense(output_dim=nb_classes, activation='sigmoid')(x)  ###-----softmax--singleLabel; sigmoid--multiLabel
