...
def create_inception_v4(nb_classes=14944, load_weights=True):  ##classes=1001,14951,14944
    '''
    ...
    # Output
    out2 = Dense(output_dim=nb_classes, activation='softmax', name='fine-tune2')(x)  ##change name to fine-tune

    model = Model(init, out2, name='Inception-v4')
...
#     weights="inception_v4_weights_tf_dim_ordering_tf_kernels.h5"
    #weights="temp.h5"

    #model.load_weights(weights,by_name=True)  ############by_name=True
